...
```bash
git remote add encore encore://hi-emma-morning-routine-f5ci
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/hi-emma-morning-routine-f5ci/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/hi-emma-morning-routine-f5ci/settings/integrations/github)
