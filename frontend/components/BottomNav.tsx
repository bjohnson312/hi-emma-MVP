...
export default function BottomNav({ designVersion, activeView, onNavigate, onMenuOpen }: BottomNavProps) {
  const tabs = [
  ...
  return (
    <div 
      className="fixed top-0 left-0 right-0 z-50 md:hidden bg-gradient-to-r from-[#4e8f71] to-[#6ba583] shadow-lg"
      style={{
        paddingTop: 'env(safe-area-inset-top, 0px)'
      }}
    >
      <div className="flex items-center justify-between h-16 px-4">
        <span className="text-white font-semibold text-lg">Hi, Emma</span>
